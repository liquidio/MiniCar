...
void motor_config(){
   ...
   //设置该引脚为复用输出功能,输出TIM1 CH1的PWM脉冲波形
	...
	GPIO_SetBits(GPIOB,GPIO_Pin_15);//电机使能
	...
	TIM_OCInitStructure.TIM_OCIdleState = TIM_OCNIdleState_Reset;//TIM8与其他tim不同的。
	...
	TIM_CtrlPWMOutputs(TIM8,ENABLE);	//MOE 主输出使能	TIM8
